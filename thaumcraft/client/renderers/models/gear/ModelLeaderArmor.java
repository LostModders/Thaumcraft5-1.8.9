...
/*     */     
/* 240 */     this.field_178720_f.field_78804_l.clear();
...
/* 245 */     this.field_178721_j.field_78804_l.clear();
/* 246 */     this.field_178722_k.field_78804_l.clear();
/*     */     
...
/*     */     }
/*     */     
/* 275 */     this.field_178723_h.field_78804_l.clear();
/* 276 */     this.field_178723_h.func_78792_a(this.ShoulderR);
/* 277 */     this.field_178723_h.func_78792_a(this.ShoulderR1);
/* 278 */     this.field_178723_h.func_78792_a(this.ShoulderR2);
/* 279 */     this.field_178723_h.func_78792_a(this.ShoulderR3);
/* 280 */     this.field_178723_h.func_78792_a(this.ShoulderR4);
/* 281 */     this.field_178723_h.func_78792_a(this.ShoulderR5);
/* 282 */     this.field_178723_h.func_78792_a(this.GauntletR);
/* 283 */     this.field_178723_h.func_78792_a(this.GauntletR2);
/* 284 */     this.field_178723_h.func_78792_a(this.GauntletstrapR1);
/* 285 */     this.field_178723_h.func_78792_a(this.GauntletstrapR2);
/*     */     
/* 287 */     this.field_178724_i.field_78804_l.clear();
/* 288 */     this.field_178724_i.func_78792_a(this.ShoulderL);
/* 289 */     this.field_178724_i.func_78792_a(this.ShoulderL1);
/* 290 */     this.field_178724_i.func_78792_a(this.ShoulderL2);
/* 291 */     this.field_178724_i.func_78792_a(this.ShoulderL3);
/* 292 */     this.field_178724_i.func_78792_a(this.ShoulderL4);
/* 293 */     this.field_178724_i.func_78792_a(this.ShoulderL5);
/* 294 */     this.field_178724_i.func_78792_a(this.GauntletL);
/* 295 */     this.field_178724_i.func_78792_a(this.GauntletL2);
/* 296 */     this.field_178724_i.func_78792_a(this.GauntletstrapL1);
/* 297 */     this.field_178724_i.func_78792_a(this.GauntletstrapL2);
/*     */     
/* 299 */     this.field_178721_j.func_78792_a(this.BackpanelR1);
/* 300 */     this.field_178721_j.func_78792_a(this.BackpanelR2);
/* 301 */     this.field_178721_j.func_78792_a(this.BackpanelR3);
/* 302 */     this.field_178721_j.func_78792_a(this.BackpanelR4);
/*     */     
/* 304 */     this.field_178722_k.func_78792_a(this.BackpanelL1);
/* 305 */     this.field_178722_k.func_78792_a(this.BackpanelL2);
/* 306 */     this.field_178722_k.func_78792_a(this.BackpanelL3);
/* 307 */     this.field_178722_k.func_78792_a(this.BackpanelL4);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 316 */     float a = MathHelper.func_76134_b(f * 0.6662F) * 1.4F * f1;
/* 317 */     float b = MathHelper.func_76134_b(f * 0.6662F + 3.1415927F) * 1.4F * f1;
/* 318 */     float c = Math.min(a, b);
/*     */     
/* 320 */     this.LegClothR.field_78795_f = (a - 0.1047198F);
/* 321 */     this.LegClothL.field_78795_f = (b - 0.1047198F);
/*     */     
/* 323 */     this.Cloak1.field_78795_f = (-c / 2.0F + 0.1396263F);
/* 324 */     this.Cloak2.field_78795_f = (-c / 2.0F + 0.3069452F);
/* 325 */     this.Cloak3.field_78795_f = (-c / 2.0F + 0.4465716F);
/*     */     
/* 327 */     if (this.field_78091_s) {
/* 328 */       float f6 = 2.0F;
/* 329 */       GL11.glPushMatrix();
/* 330 */       GL11.glScalef(1.5F / f6, 1.5F / f6, 1.5F / f6);
/* 331 */       GL11.glTranslatef(0.0F, 16.0F * f5, 0.0F);
/* 332 */       this.field_78116_c.func_78785_a(f5);
...
/* 337 */       this.field_78115_e.func_78785_a(f5);
/* 338 */       this.field_178723_h.func_78785_a(f5);
/* 339 */       this.field_178724_i.func_78785_a(f5);
/* 340 */       this.field_178721_j.func_78785_a(f5);
/* 341 */       this.field_178722_k.func_78785_a(f5);
/* 342 */       this.field_178720_f.func_78785_a(f5);
/* 343 */       GL11.glPopMatrix();
/*     */     } else {
/* 345 */       GL11.glPushMatrix();
/* 346 */       GL11.glScalef(1.01F, 1.01F, 1.01F);
/* 347 */       this.field_78116_c.func_78785_a(f5);
/* 348 */       GL11.glPopMatrix();
/* 349 */       this.field_78115_e.func_78785_a(f5);
/* 350 */       this.field_178723_h.func_78785_a(f5);
/* 351 */       this.field_178724_i.func_78785_a(f5);
/* 352 */       this.field_178721_j.func_78785_a(f5);
/* 353 */       this.field_178722_k.func_78785_a(f5);
/* 354 */       this.field_178720_f.func_78785_a(f5);
/*     */     }
/*     */   }
/*     */   
/*     */   private void setRotation(ModelRenderer model, float x, float y, float z) {
/* 359 */     model.field_78795_f = x;
/* 360 */     model.field_78796_g = y;
/* 361 */     model.field_78808_h = z;
/*     */   }
/*     */ }


/* Location:              /Users/shannon/Desktop/Thaumcraft-1.8.9-5.2.4.jar!/thaumcraft/client/renderers/models/gear/ModelLeaderArmor.class
