...
/*  73 */       ht = tentacle.field_70737_aN;
/*     */       
/*  75 */       float mod = par6 * 0.2F;
/*  76 */       float fs = flail > 1.0F ? 3.0F : 1.0F + (flail > 1.0F ? mod : -mod);
/*  77 */       float fi = flail + ((ht > 0) || (at > 0) ? mod : -mod);
/*     */       
/*  79 */       this.tentacle.field_78795_f = 0.0F;
/*  80 */       for (int k = 0; k < this.length - 1; k++)
/*     */       {
/*  82 */         this.tents[k].field_78795_f = (0.15F * fi * MathHelper.func_76126_a(par3 * 0.1F * fs - k / 2.0F));
/*  83 */         this.tents[k].field_78808_h = (0.1F / fi * MathHelper.func_76126_a(par3 * 0.15F - k / 2.0F));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  94 */     func_78087_a(par2, par3, par4, par5, par6, par7, par1Entity);
/*  95 */     GL11.glPushMatrix();
/*  96 */     GL11.glEnable(3042);
/*  97 */     GL11.glBlendFunc(770, 771);
/*  98 */     float height = 0.0F;
/*  99 */     float hc = par1Entity.field_70131_O * 10.0F;
/* 100 */     if (par1Entity.field_70173_aa < hc) {
/* 101 */       height = (hc - par1Entity.field_70173_aa) / hc * par1Entity.field_70131_O;
/*     */     }
/* 103 */     GL11.glTranslatef(0.0F, (par1Entity.field_70131_O == 3.0F ? 0.6F : 1.2F) + height, 0.0F);
/* 104 */     GL11.glScalef(par1Entity.field_70131_O / 3.0F, par1Entity.field_70131_O / 3.0F, par1Entity.field_70131_O / 3.0F);
...
/* Location:              /Users/shannon/Desktop/Thaumcraft-1.8.9-5.2.4.jar!/thaumcraft/client/renderers/models/entity/ModelTaintacle.class
