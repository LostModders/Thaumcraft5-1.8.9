...
/*  582 */           tessellator.func_178180_c().func_181668_a(7, DefaultVertexFormats.field_181705_e);
/*  583 */           tessellator.func_178180_c().func_181662_b(this.posX, this.posY + this.FONT_HEIGHT / 2, 0.0D).func_181675_d();
/*  584 */           tessellator.func_178180_c().func_181662_b(this.posX + f1, this.posY + this.FONT_HEIGHT / 2, 0.0D).func_181675_d();
/*  585 */           tessellator.func_178180_c().func_181662_b(this.posX + f1, this.posY + this.FONT_HEIGHT / 2 - 1.0F, 0.0D).func_181675_d();
/*  586 */           tessellator.func_178180_c().func_181662_b(this.posX, this.posY + this.FONT_HEIGHT / 2 - 1.0F, 0.0D).func_181675_d();
...
/*      */         {
/*  593 */           Tessellator tessellator = Tessellator.func_178181_a();
/*  594 */           GL11.glDisable(3553);
/*  595 */           tessellator.func_178180_c().func_181668_a(7, DefaultVertexFormats.field_181705_e);
/*  596 */           int l = this.underlineStyle ? -1 : 0;
/*  597 */           tessellator.func_178180_c().func_181662_b(this.posX + l, this.posY + this.FONT_HEIGHT, 0.0D).func_181675_d();
/*  598 */           tessellator.func_178180_c().func_181662_b(this.posX + f1, this.posY + this.FONT_HEIGHT, 0.0D).func_181675_d();
/*  599 */           tessellator.func_178180_c().func_181662_b(this.posX + f1, this.posY + this.FONT_HEIGHT - 1.0F, 0.0D).func_181675_d();
/*  600 */           tessellator.func_178180_c().func_181662_b(this.posX + l, this.posY + this.FONT_HEIGHT - 1.0F, 0.0D).func_181675_d();
...
/*  881 */               Minecraft.func_71410_x().field_71446_o.func_110577_a(this.rl1);
/*  882 */               gui.func_73729_b(par2 + par4 / 2 - 48, par3 + 2, 24, 184, 96, 4);
/*      */             }
...
/*  889 */               Minecraft.func_71410_x().field_71446_o.func_110577_a(rl2);
...
/*  895 */               gui.func_73729_b(0, 0, Integer.parseInt(scont[2]), Integer.parseInt(scont[3]), Integer.parseInt(scont[4]), Integer.parseInt(scont[5]));
/*      */               
/*      */ 
...
/*      */       }
/*      */       else {
/*  905 */         this.renderEngine.func_110577_a(this.field_111273_g);
...
/* Location:              /Users/shannon/Desktop/Thaumcraft-1.8.9-5.2.4.jar!/thaumcraft/client/lib/TCFontRenderer.class
